...
const MessageMediaPicker = ({ isOpen, onClose, onEmojiClick, onGifClick }) => {
    ...
    const searchPlaceholder = activeTab === "emoji" ? "Search emoji" : activeTab === "gif" ? "Search GIFs" : "Search stickers";
    ...
    const saveRecentGif = gif => {
        ...
        const updated = [gif, ...existing.filter(
            item =>
                String(item.id) !==
                String(gif.id)
        ),
                                ...
                                search.trim()
                                    ...
                                    : (
                                        <EmojiPicker
                                            ...
                                            lazyLoadEmojis={true}
                                            theme="dark"
                                            style={{ background: "#101610", border: "none", borderRadius: 0 }}
                                        />
                                    )
                            }
