export const getUnreadMessageCount = (chat, userId) => {
  if (!chat || !userId) {
    return 0;
  }

  const unreadCounts = chat.unreadMessageCount;
...
export const hasUnreadMessages = (chat, userId) => {
  return getUnreadMessageCount(chat, userId) > 0;
};

export const getFirstUnreadIndex = (messages, unreadCount) => {
